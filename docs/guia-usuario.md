...
### 4.2 Carreras
Cada carrera muestra: nombre, escuela, descripción, duración, modalidad, **requisitos** y **documentos relacionados**.

### 4.3 Cursos (`Formación → Escuelas` o la vista de cursos)
...
## 5. Ingreso (postulantes)

| Página | Para qué sirve |
|---|---|
| **Convocatorias vigentes** | Ver las inscripciones abiertas ahora |
| **Próximas convocatorias** | Ver aperturas anunciadas para los próximos ciclos |
| **Requisitos** | Requisitos generales y documentación necesaria |
| **Proceso de ingreso** | Pasos: registro → inscripción → documentación → evaluaciones → confirmación |
| **Preguntas frecuentes** | Resolver dudas comunes; tocá cada pregunta para ver la respuesta |

---

## 6. Aplicaciones institucionales (personal)

En la página de inicio, más abajo de las noticias, encontrás la sección **"Aplicaciones Institucionales"**:

| Aplicación | Para qué sirve |
|---|---|
| **Mi ISeP** | Trámites y consultas personales |
| **SIGEDI** | Sistema de Gestión Educativa |
| **Webmail** | Correo institucional |

Cada tarjeta abre el sistema correspondiente en una pestaña nueva.

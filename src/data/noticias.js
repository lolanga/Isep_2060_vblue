...
export const noticias = [
    {
    id: 16,
    titulo: "Suspensión de actividades presenciales en Sede Recreo",
    categoria: "Academica",
...
<blockquote><p>Suspensión de actividades presenciales sede RECREO ☔</p></blockquote><p>Se informa al alumnado que, debido a las inclemencias climáticas, se suspenden las actividades presenciales del día miércoles 19 de agosto.</p><p>Actividades afectadas</p><p>Clases presenciales de materias operacionales del <strong>GRUPO 2</strong> de la jerarquía <strong>SUBINSPECTOR</strong> <strong>Aulas 6, 7, 8, 9 y 10</strong></p><p>Próxima clase: Miércoles 2 de septiembre</p><p>La próxima clase correspondiente a este grupo se desarrollará en dicha fecha.</p><p><strong>Importante</strong>: cualquier novedad respecto al cursado será comunicada oportunamente por este medio.</p><p>Consultas y contacto: Correo electrónico</p><p><a target="_blank" rel="noreferrer" href="mailto:escueladeespecialidades@isepsantafe.edu.ar">escueladeespecialidades@isepsantafe.edu.ar</a></p><p>Teléfono: 4815571</p><p>Escuela de Especialidades en Seguridad · Curso de Actualización y Perfeccionamiento · Ciclo 2027</p>
  ...
  },
  {
    ...
    img: "https://picsum.photos/seed/primeraux/800/450",
    escuelas: ["especialidades"],
  },
  {
    id: 3,
    ...
    img: "https://picsum.photos/seed/conveniounl/800/450",
    escuelas: ["superior"],
  },
  {
    id: 4,
    ...
    img: "https://picsum.photos/seed/comunitaria/800/450",
  ...
  },
  {
    ...
    img: "https://picsum.photos/seed/bienvenida2026/800/450",
  ...
  },
  {
    ...
    img: "https://picsum.photos/seed/conferenciaintl/800/450",
    escuelas: ["superior"],
  },
  {
    id: 7,
    ...
    img: "https://picsum.photos/seed/forensedigital/800/450",
    escuelas: ["investigaciones"],
  },
  {
    id: 8,
    ...
    img: "https://picsum.photos/seed/convenioutn/800/450",
    escuelas: ["superior"],
  },
  {
    id: 9,
    ...
    img: "https://picsum.photos/seed/tallerosario/800/450",
    escuelas: ["especialidades"],
  },
  {
    id: 10,
    ...
    img: "https://picsum.photos/seed/graduacion2026/800/450",
    escuelas: ["policia"],
  },
  {
    id: 11,
    ...
    img: "https://picsum.photos/seed/planestudios/800/450",
    escuelas: ["superior"],
  },
  {
    id: 12,
    ...
    img: "https://picsum.photos/seed/gestioncrisis/800/450",
    escuelas: ["superior"],
  },
  {
    id: 13,
    ...
    img: "https://picsum.photos/seed/bibliotecavirtual/800/450",
    escuelas: ["policia", "superior", "especialidades", "investigaciones", "ead"],
  },
  {
    id: 14,
    ...
    img: "https://picsum.photos/seed/simulacroruta19/800/450",
    escuelas: ["policia"],
  },
];

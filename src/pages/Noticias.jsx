...
export default function Noticias() {
  ...
  const filtradas = NOTICIAS.filter(
    (n) => categoriaActiva === "Todas" || n.categoria === categoriaActiva
  );
        ...
        {principal && (
          <section className="noticias-principal">
            <div className="np-badge-row">
              <span className="badge-categoria badge-categoria--highlight">
                ULTIMA PUBLICACION
              </span>
                ...
                <div className="pag-nums">
                  {Array.from({ length: totalPaginas }, (_, i) => i + 1).map((n) => (
                    <button
                      key={n}
                      type="button"
                      className={`pag-num${pagina === n ? " pag-num--active" : ""}`}
                      onClick={() => setPagina(n)}
                    >
                      {n}
                    </button>
